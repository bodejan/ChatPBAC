...
RETRIEVAL_EXAMPLES = [
    {
        ...
        "output": "{\"action\": \"find\", \"query\": {\"DiagnosisCategory\": \"Cancer\", \"DiagnosisCategory_IP\": \"Research\"}}"
    },
    {
    ...
    },
    {
        ...
        "output": "{\"action\": \"find\", \"query\": {\"TreatmentCategory\": \"Pharmacy\", \"TreatmentCategory_IP\": \"Public-Research\"}}"
    },
    {
        "input": "How many patients are covered by Medicaid? Access Purpose: 'Patient-Support-Service'", 
        "output": "{\"action\": \"countDocuments\", \"query\": {\"PatientInsuranceProvider\": \"Medicaid\", \"PatientInsuranceProvider_IP\": \"Patient-Support-Service\"}}"
    },
    {
    ...
    {
        "input": "Retrieve all entries where the Determination is Overturned. Access Purpose: 'Clinical-Care'", 
        "output": "{\"action\": \"find\", \"query\": {\"Determination\": \"Overturned Decision of Health Plan\", \"Determination_IP\": \"Clinical-Care\"}}"
    },
    {
    ...
    {
        "input": "Give me the data for patients with the blood type 'O+'. Access Purpose: 'Non-Military-Research'", 
        "output": "{\"action\": \"find\", \"query\": {\"PatientBloodType\": \"O+\", \"PatientBloodType_IP\": \"Non-Military-Research\"}}"
    }
]
